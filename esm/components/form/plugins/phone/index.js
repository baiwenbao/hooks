...
var Phone = function (props) {
    ...
    return (React.createElement(Input, { addonBefore: select, value: phoneValue, onChange: handleChange, style: { width: width }, onBlur: function () { return blur$.next(undefined); } }));
};
// @ts-ignore
plugins.field.tap('phone', function (customFieldProps) {
    // @ts-ignore
    return React.createElement(Phone, __assign({}, customFieldProps));
});
